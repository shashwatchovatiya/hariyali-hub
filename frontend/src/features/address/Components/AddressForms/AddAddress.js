...
function AddAddress() {
    ...
    }, [isRedirectAllowed, dispatch, location.search, navigate]);
    ...
    const handleAddNewAddress = async (e) => {
        ...
        dispatch(addNewAddressAsync({ address }))
    }
                ...
                <div className="col-sm-12 col-md-9 border py-3 shadow rounded bg-section">
                    ...
                    <div className="row p-4">
                        <form onSubmit={handleAddNewAddress}>
                            ...
                            <button type="submit" className="btn btn-primary btn-block mb-2"><i className="fas fa-plus"></i> Save Address</button>
                        </form>
                    </div>
                </div>
            </div>
