    ...
    return (
        <div className="col-lg-5 ps-4 mt-3">
            <div className="row">
                ...
                {product.nursery && (
                    <small style={{ position: "relative", top: "5px", left: "3px" }}>
                        <Link to={`/nursery/store/view/${product.nursery._id}`} className='small link-secondary'>
                            <i className="fas fa-store"></i> {product.nursery.nurseryName}
                        </Link>
                    </small>
                )}
