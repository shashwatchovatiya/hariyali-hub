...
const ContactUs = () => {
    ...
    return (
        <section className='bg-section py-sm-5 contact-us'>
            <div className="container p-0 overflow-hidden rounded-corner">
                <div className="row g-0 full-height px-0 px-md-5" style={{ minHeight: "70vh" }}>
                    ...
                    <div className="col-12 col-md-6 d-flex flex-column justify-content-center align-items-start bg-dark text-white p-5">
                        ...
                        <div className="mb-3">
                            <a className='text-light' href='mailto:shashwatchovatiya316@gmail.com'>
                                <i className="fas fa-envelope me-2"></i>
                                <span>Email: shashwatchovatiya316@gmail.com</span>
                            </a>
                        </div>
                        <div className="mb-3">
                            <a className='text-light' href='tel:+918866187676'>
                                <i className="fas fa-phone me-2"></i>
                                <span>Phone: +918866187676</span>
                            </a>
                        </div>
                        <div>
                            <i className="fas fa-map-marker-alt me-2"></i>
                            <span>Address: Sardar Patel Ring Rd, near galaxy business park, Nikol, Ahmedabad</span>
                        </div>
                    </div>
